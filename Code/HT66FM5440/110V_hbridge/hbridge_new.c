...
/* PWM constants */
	...
	#define PWM_STEPUP_DT 100 // (n+1)x 1ms 
	#define PWM_STEPUP_DUTY 1
	#define PWM_STEPDOWN_DT 100 // (n+1)x 1ms 
	#define PWM_STEPDOWN_DUTY 1	
#else
	#define PWM_PERIOD 200 // * 0.5us
	#define PWM_DUTY_MAX 190 // x 0.5us full PWM_PERIOD 
	#define PWM_DUTY_MIN 0 // x 0.5us full PWM_PERIOD 
	#define PWM_STEPUP_DT 1 // (n+1)x 1ms 
	#define PWM_STEPUP_DUTY 1
	#define PWM_STEPDOWN_DT 1 // (n+1)x 1ms 
	#define PWM_STEPDOWN_DUTY 1	
#endif
	
#define PWM_DEAD_TIME 1 // (dead time + 1)x0.5us
