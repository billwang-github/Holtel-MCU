...
DEFINE_SFR(__integ1_type, __integ1, 0x10);	//中斷
...
DEFINE_SFR(__pawu_type, __pawu, 0x1c);	//IO口
...
DEFINE_SFR(__captc0_type, __captc0, 0x29);	//捕捉定時器
...
DEFINE_SFR(__sfr_byte, __adrl, 0x31);	//AD
DEFINE_SFR(__sfr_byte, __adrh, 0x32);
DEFINE_SFR(__sfr_word, _addata, 0x31);	//2014-07-16
...
DEFINE_SFR(__pbps0_type, __pbps0, 0x3b); 	//引腳複用
DEFINE_SFR(__pbps1_type, __pbps1, 0x3c);
DEFINE_SFR(__pbps2_type, __pbps2, 0x3d);

DEFINE_SFR(__integ0_type, __integ0, 0x3e);	//Hall中斷源選擇、中斷邊沿選擇
...
DEFINE_SFR(__ptm1c0_type, __ptm1c0, 0x47);	//Timer1
...
DEFINE_SFR(__ptm0c0_type, __ptm0c0, 0x4f);	//Timer0
...
DEFINE_SFR(__ptm2c0_type, __ptm2c0, 0x57);	//Timer2
...
DEFINE_SFR(__pwmc_type, __pwmc, 0x5f);	//PWM
...
DEFINE_SFR(__iicc0_type, __iicc0, 0x70);	//IIC
...
DEFINE_SFR(__usr_type, __usr, 0x75);	//UART
...
DEFINE_SFR(__cpc_type, __cpc, 0x7b);	//比較器
...
DEFINE_SFR(__opoms_type, __opoms, 0x16e);	//過流保護
DEFINE_SFR(__sfr_byte, __opcm, 0x16f);
DEFINE_SFR(__opacal_type, __opacal, 0x170);

DEFINE_SFR(__ptm3c0_type, __ptm3c0, 0x171);	//Timer3
...
DEFINE_SFR(__paps0_type, __paps0, 0x17a);	//引腳複用
...
#define _emi      __intc0.bits.__emi	//中斷控制位
